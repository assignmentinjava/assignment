...
public class Vertex implements Comparable<Vertex>{
    ...
    private int time =Integer.MAX_VALUE; //Will be the total time for the shortest path to this Vertex from the source Vertex specfied in the AirBaggageRouteGraphMap
    ...
    /**
     * Return the shortest path to this Vertex from a source specified in a AirBaggageRouteGraphMap after running the AirBaggageRoute algorithm
