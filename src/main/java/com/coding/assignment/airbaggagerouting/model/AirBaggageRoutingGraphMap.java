package com.coding.assignment.airbaggagerouting.model;
...
public class AirBaggageRoutingGraphMap {
    // mapping of vertex names to Vertex objects, built from a set of Edges
    private final Map<String, Vertex> graphMap;
    public AirBaggageRoutingGraphMap(List<DirectedEdge> directedEdges) {
     ...
     */
    public void airBaggageRouting(String startName) {
        if (!graphMap.containsKey(startName)) {
            throw new AirBaggageRoutingGraphMapException("This AirBaggageRoutingGraphMap does not contain the starting Vertex named:"+startName);
        }
    ...
    public List<Vertex> getShortestPath(String endName){
        if (!graphMap.containsKey(endName)) {
            throw new AirBaggageRoutingGraphMapException("Graph doesn't contain end vertex : "+endName);
        }
