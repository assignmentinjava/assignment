...
import com.coding.assignment.airbaggagerouting.model.Bag;
import com.coding.assignment.airbaggagerouting.model.DirectedEdge;

public class AirBaggageRoutingMain {
    ...
    public static void main(String [] args){
        ...
        if(args.length >0) {
            ...
            scan=promptAndParse();
        if(scan != null){
            List<DirectedEdge> edges= parseInputBaggageDetails(scan);
            AirBaggageRoutingAlgorithm airBaggageRoutingAlgorithm = AirBaggageRoutingAlgorithmFactory.createAirBaggageRoutingAlgorithm();
            ...
            for(Bag bag:bagList){
                ...
                String pathLine=airBaggageRoutingAlgorithm.findShortestPath(entryGate,destGate,edges);
    ...
    private static List<DirectedEdge> parseInputBaggageDetails(Scanner scanner){
